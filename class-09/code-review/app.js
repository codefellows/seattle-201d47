...
function Store(minumumCustomers, maximumCustomers, averageCookies, locationName) {
    ...
    this.render = function () {
        ...
        this.cookiesBought(); // Vinicio - smells - improve on name
        var totalPerStore = 0;
...
// Vinicio - by convention constructors are capitalized, this is not a constructor
function renderHeader() {
    // this. is not present in this function.
...
function addNewStore(event) {
    ...
    var minimumCustomersNumber = event.target.minimumCustomers.value;

    // Vinicio - this seems like a debug line
    console.log(minimumCustomers); // vinicio - smells - use breakpoints

    // Vinicio - great job, smells great!
