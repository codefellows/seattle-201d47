...
// Question - I was having trouble being able to break out of this while loop. I tried inputting the word, break, on line107. It did not work. I tried adding '&& guessWhichpet !== petsIhad.length' onto line 98, but since I had not yet run the code  to check through my array, the condition to run the loop was never true. So I ended up changing the number of guesses to 0 on line 107, which closes the loop with a correct answer.
while(numberOfGuesses > 0 && userGuessedCorrectly === false) {
